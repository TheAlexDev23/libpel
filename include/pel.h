...
/* 
* Draws circle of radius r with it's center at image center + (x, y)
* Filename needs to be valid png otherwise will return -1
*/
extern int pel_draw_circle(pel_color_t brush_color, int x, int y, int r);

/* 
* Draws filled circle of radius r with it's center at image center + (x, y)
* Filename needs to be valid png otherwise will return -1
*/
extern int pel_draw_circle_full(pel_color_t brush_color, int x, int y, int r);
#endif